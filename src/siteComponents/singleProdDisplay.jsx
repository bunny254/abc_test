      ...
      <div className="hidden xl:grid">
        ...
        <div className="flex justify-center items-center gap-16">
          ...
          <div className="grid grid-cols-12">
            ...
            <p className="mt-3">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Maxime qui molestiae provident illum dignissimos eligendi at, minus beatae ad vel incidunt, et earum ipsum alias architecto rerum laborum accusamus dolor.</p>
            <p className="mt-3">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Maxime qui molestiae provident illum dignissimos eligendi at, minus beatae ad vel incidunt, et earum ipsum alias architecto rerum laborum accusamus dolor.Lorem, ipsum dolor sit amet consectetur adipisicing elit.</p>
            </div>
